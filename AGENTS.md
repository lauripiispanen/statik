...
- When the user invokes `/iteration`, read `.claude/skills/iteration/SKILL.md` and follow its instructions directly (it has `disable-model-invocation: true`). Do NOT start manual planning or solo work — spin up the full team as specified.
